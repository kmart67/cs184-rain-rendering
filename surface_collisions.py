...
def initscene():
    ...
    # addplane(location=(0,0,0.15))
    # bpy.ops.transform.rotate(value=-0.55146, axis=(0,1,0), constraint_axis=(False, True, False), constraint_orientation='GLOBAL', mirror=False, proportional='DISABLED', proportional_edit_falloff='SMOOTH', proportional_size=1)
...
"""
def fall_and_collide(droplets, objects, layer_dict):
        ...
        for i in range(frames):
            ...
            for v in bm.verts:
                ...
                for obj in objects:
                    ...
                    p1 = obj.matrix_world * obj.data.vertices[0].co
                    p2 = obj.matrix_world * obj.data.vertices[1].co
                    p3 = obj.matrix_world * obj.data.vertices[2].co
                    ...
                    if detected:
                        ...
                        # # Viscosity update.
                        v_new = (1 - MU * dt) * v_old + NU * v_old * dt
